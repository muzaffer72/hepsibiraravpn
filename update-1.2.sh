...
wget -O addd-ssh "https://raw.githubusercontent.com/EvoTeamMalaysia/AutoScriptVPS/main/add-ssh.sh"
...
wget -O add-sstp "https://raw.githubusercontent.com/EvoTeamMalaysia/AutoScriptVPS/main/add-sstp.sh"
